...
class TournamentKitTests: XCTestCase {
    ...
    func testExample() throws {
        ...
        let scores1_1 = [0, 1]
        XCTAssertNoThrow(try manager.applyTestScores(scores1_1, for: &match1_1, overtimeSuffix: nil))
        ...
        let scores1_2 = [0, 1]
        XCTAssertNoThrow(try manager.applyTestScores(scores1_2, for: &match1_2, overtimeSuffix: "OT"))
        ...
        let scores2_1_1 = [1, 2]
        XCTAssertNoThrow(try manager.applyTestScores(scores2_1_1, for: &match2_1, overtimeSuffix: nil))
        ...
        let scores2_1_2 = [0, 2]
        XCTAssertNoThrow(try manager.applyTestScores(scores2_1_2, for: &match2_1, overtimeSuffix: nil))
